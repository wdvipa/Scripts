...
阿里云盘签到cookie = requires-body=1,type=http-response,pattern=https:\/\/auth.aliyundrive.com\/v2\/account\/token,script-path=https://raw.githubusercontent.com/wdvipa/Scripts/master/ali/aliYunPanCheckIn.js
阿里云盘签到 = type=cron,cronexp="0 10 0 * * ?",wake-system=1,script-path=https://raw.githubusercontent.com/wdvipa/Scripts/master/ali/aliYunPanCheckIn.js
...
[rewrite_local]
#阿里云盘签到cookie
^https:\/\/auth.aliyundrive.com\/v2\/account\/token url script-response-body https://raw.githubusercontent.com/wdvipa/Scripts/master/ali/aliYunPanCheckIn.js

[task_local]
0 10 0 * * ? https://raw.githubusercontent.com/wdvipa/Scripts/master/ali/aliYunPanCheckIn.js
...
[Script]
http-response https:\/\/auth.aliyundrive.com\/v2\/account\/token script-path=https://raw.githubusercontent.com/wdvipa/Scripts/master/ali/aliYunPanCheckIn.js, requires-body=true, timeout=10, tag=阿里云盘签到cookie
cron "0 10 0 * * ?" script-path=https://raw.githubusercontent.com/wdvipa/Scripts/master/ali/aliYunPanCheckIn.js, tag=阿里云盘签到
...
const aliYunPanRefreshTokenKey = 'token'
let aliYunPanRefreshToken = 'token'
